...
import { handleSmartReply } from './actions';
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Enter a customer's query to generate a professional and helpful reply using AI.
                    </CardDescription>
                </CardHeader>
                ...
                {(reply || isLoading || error) && (
                    <CardFooter>
                        <div className="w-full space-y-4">
                            ...
                            <Card className="min-h-[120px] bg-muted/50 relative">
                                <CardContent className="p-4 pr-12">
                                    {isLoading && <p className="text-muted-foreground animate-pulse">Generating...</p>}
