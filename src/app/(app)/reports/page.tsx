...
import { DollarSign, Coins, TrendingUp, TrendingDown, Loader2 } from 'lucide-react';
...
export default function ReportsPage() {
    ...
    const handleGenerateReport = async () => {
        ...
        try {
            // 1. Find all reservations for the selected vehicle
            ...
            // 4. Calculate net profit and set data
            ...
            {reportData && (
                <div className="space-y-6">
                    <div className="grid gap-4 md:grid-cols-3">
                         ...
                         <StatCard title="Net Profitability" value={formatCurrency(reportData.netProfit)} icon={DollarSign} colorClass={reportData.netProfit >= 0 ? "text-green-500" : "text-red-500"}/>
                    </div>
