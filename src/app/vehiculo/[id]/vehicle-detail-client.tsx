...
import { Calendar as CalendarIcon, Users, Gauge, GitBranch, User, Car, Globe, Loader2, Phone } from 'lucide-react';
...
export default function VehicleDetailClient({ initialVehicle }: { initialVehicle: Vehicle }) {
  const { user } = useAuth();
  
  const [vehicle] = React.useState<Vehicle>(initialVehicle);
